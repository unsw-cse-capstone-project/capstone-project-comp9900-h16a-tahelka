export class UserMessageConstant {
  ...
  public static get BLOCKED_USER_SUCCESSFUL(): string { return 'User has been banned'; }
  public static get BLOCKED_USER_UNSUCCESSFUL(): string { return 'User ban was not successful, try again!'; }
